...
public class CommentService {
	...
	public List<Comment> findAllCommentsForSong(@PathVariable("recipeId") int recipeId){
		
		return (List<Comment>) repository.findAllCommentsForSong(recipeService.findRecipeById(recipeId));
	}
